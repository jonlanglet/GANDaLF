...
print("Configure timestamping on a port through setTimestamping(PORT,INGRESS_ENABLED,EGRESS_ENABLED)")
print("To enable duplication on a port, run: setDuplicationLevel(PORT,DUPLICATIONLEVEL)")
print()
print("Examples:")
print()
print(" * Timestamping * ")
